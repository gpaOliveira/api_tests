...
class Logger:
    def __init__(self, test_name):
        ...
        self.logging_filename = self.__initialize_filename(self.test_name)
        self._logger = self.__initialize_log()

    def __initialize_filename(self, test_name):
        ...
        return os.path.join(test_logs_directory, "{}_{}.txt".format(test_name, now_to_str()))
